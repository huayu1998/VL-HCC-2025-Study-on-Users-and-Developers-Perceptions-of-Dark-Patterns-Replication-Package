...
6. The same rules applied to the data and analysis result files for the *non-DP-related* title (``non_dp_title.csv``), body (``non_dp_body.csv``), and review comments (``non_dp_comment.csv``). 
